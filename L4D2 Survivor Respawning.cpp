...
public OnPluginStart()
{
	...
	FirstWeapon = CreateConVar("l4d_survivorrespawn_firstweapon", "1", "Which first slot weapon will be given to the Survivor (1 - Autoshotgun, 2 - M16, 3 - None)", FCVAR_PLUGIN, true, 0.0, false, _);
	SecondWeapon = CreateConVar("l4d_survivorrespawn_secondweapon", "1", "Which second slot weapon will be given to the Survivor (1 - Bat, 2 - Dual Pistol, 3 - Magnum)", FCVAR_PLUGIN, true, 0.0, false, _);
	ThrownWeapon = CreateConVar("l4d_survivorrespawn_thrownweapon", "4", "Which thrown weapon will be given to the Survivor (1 - Moltov, 2 - Bile Jar, 3 - Pipe Bomb, 4 - None)", FCVAR_PLUGIN, true, 0.0, false, _);
	PrimeHealth = CreateConVar("l4d_survivorrespawn_primehealth", "3", "Which prime health unit will be given to the Survivor (1 - Medkit, 2 - Defib, 3 - None)", FCVAR_PLUGIN, true, 0.0, false, _);
	SecondaryHealth = CreateConVar("l4d_survivorrespawn_secondaryhealth", "1", "Which secondary health unit will be given to the Survivor (1 - Pills, 2 - Adrenaline, 3 - None)", FCVAR_PLUGIN, true, 0.0, false, _);
	...
	AutoExecConfig(true, "plugin.L4D2.SurvivorRespawn");
...
GiveItems(client)
{
	...
	switch (GetConVarInt(ThrownWeapon))
		...
		case 1:
		{
			FakeClientCommand(client, "give moltov");
		}
		case 2:
		{
